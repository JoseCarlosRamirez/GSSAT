<?php  
  class navBar{
      ...
      echo "<nav class='white' role='navigation'>
          <div class='nav-wrapper container'>
            ...
            <ul class='right hide-on-med-and-down'>
              ...
              <li ><a href=''><i class='medium material-icons' title='Ayuda'><img src='../img/system/help.png'  style='height: 30px; class='img-general'></i></a></li>
              <li ><a href='registro_pozos.php'><i class='medium material-icons' title='Usuario' style='color: black;'>supervisor_account</i></a></li>
              <li ><a href='".base_url()."Gissat/Ajustes' class='disabled'><i class='medium material-icons' title='Ajustes' style='color: black;'>settings</i></a></li>
    ...
    function map(){
      echo "<nav class='white' role='navigation'>
          <div class='nav-wrapper container'>
            <a id='logo-container' class='brand-logo' href=''><img src='../img/Empresa/Logo.png' alt='' style='height: 48px; width: 90px;'></a>
            <ul class='right hide-on-med-and-down'>
              ...
              <li ><a href=''><i class='medium material-icons' title='Usuario' style='color: black;'>supervisor_account</i></a></li>
              <li ><a href=''><i class='medium material-icons' title='Ajustes' style='color: black;'>settings</i></a></li>
